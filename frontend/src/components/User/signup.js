...
const Signup = () => {
 ...
 const [avatar, setAvatar] = useState('');
  const [avatarPreview, setAvatarPreview] = useState('https://dummyimage.com/240x240/667eea/ffffff&text=User');
  ...
  const handleSubmit = (e) => {
    ...
    // Only append avatar if it's a data URL (from file selection), not the default path
