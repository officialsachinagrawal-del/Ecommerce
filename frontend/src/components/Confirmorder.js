            ...
            <div className='mt-5'>
                ...
                cartItems&&cartItems.map(item => (
                        ...
                        key={item.product}>
                            ...
                            <p>{item.quantity} x ₹{Number(item.price).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} = <strong>₹{(item.quantity * item.price).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</strong></p>
                        </div>
                    ))
                }
            ...
            <div className='md:p-[5em]  border-r-2 p-2 mb-10  ' >
               ...
               <div>
                ...
                <p className='flex justify-between mt-5'>
                    ...
                    <span>₹{Number(shippingCharges).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </p>

                <p className='flex justify-between mt-5'>
                    <span className='font-semibold'>Tax</span>
                    <span>₹{Number(tax).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </p>
