  ...
  <h1 className='flex justify-center text-xl font-semibold'>No Item in Cart</h1>
            ...
            <div>
               ...
               cartItems &&   cartItems.map((item)=>{
                        ...
                        return <div key={product} className='grid grid-cols-2 mb-10   align-middle'>
                            ...
                            <div className='grid grid-cols-2  align-middle'>
                              ...
                              <img src={image} className='block md:max-w-[50%] md:w-[50%] max-w-[100%] w-[100%]  mx-auto my-auto ' alt="" />
                                ...
                                <div className='my-auto md:ml-0   ml-2  ' >
                                    ...
                                    <p className='font-[400] md:text-[1em] text-[0.6em]' >₹{Number(price).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                ...
                <div className='flex  justify-between w-[75%] mx-auto mt-6'>
                    ...
                    <h1>
           <span className='font-bold text-[0.9em] md:text-xl'>₹{cartItems.reduce((acc, item) => acc + item.quantity * item.price, 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                    </h1>
